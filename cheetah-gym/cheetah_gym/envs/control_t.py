...
class control_t(object):
    __slots__ = ["reset", "visual", "controlInfo"]

    __typenames__ = ["boolean", "boolean", "spi_command_t"]
    ...
    def __init__(self):
        self.reset = False
        self.visual = False
        self.controlInfo = spi_command_t()
    ...
    def _encode_one(self, buf):
        buf.write(struct.pack(">bb", self.reset, self.visual))
        assert self.controlInfo._get_packed_fingerprint() == spi_command_t._get_packed_fingerprint()
        self.controlInfo._encode_one(buf)
    ...
    def _decode_one(buf):
        ...
        self.visual = bool(struct.unpack('b', buf.read(1))[0])
        self.controlInfo = spi_command_t._decode_one(buf)
        return self
    _decode_one = staticmethod(_decode_one)
    ...
    def _get_hash_recursive(parents):
        ...
        newparents = parents + [control_t]
        tmphash = (0x8c0ccdcf91742bc8+ spi_command_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
        tmphash  = (((tmphash<<1)&0xffffffffffffffff) + (tmphash>>63)) & 0xffffffffffffffff
        return tmphash
    _get_hash_recursive = staticmethod(_get_hash_recursive)
    _packed_fingerprint = None
